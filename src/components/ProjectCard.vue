<template >
    <v-container>
      <v-row>
        <v-col no-gutters class="profile-card" v-for="project in projects" :key="project.attributes.Order"
          >
            ...
            <v-card v-ripple :alt="project.attributes.Alt" role="button">
              <v-img :src="project.attributes.Image.data.attributes.caption" :title="project.attributes.Alt" min-width="250px"
                ...
                <div class="profile-info">
                  <v-card-title class="text-white d-flex justify-start font-weight-regular text-left profile-title"
                    v-text="project.attributes.Name"></v-card-title>
                  <v-card-text class="text-white font-weight-bold d-flex justify-start text-left profile-subtitle"
                    v-text="project.attributes.Role"></v-card-text>
                  <v-card-text class="text-white text-left profile-description"
                    v-text="project.attributes.Description"></v-card-text>
                </div>
              </v-img>
            </v-card>
          </router-link>
